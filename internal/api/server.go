...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/upstream-response-header-timeout", s.mgmt.GetUpstreamResponseHeaderTimeout)
		mgmt.PUT("/upstream-response-header-timeout", s.mgmt.PutUpstreamResponseHeaderTimeout)
		mgmt.PATCH("/upstream-response-header-timeout", s.mgmt.PutUpstreamResponseHeaderTimeout)
		mgmt.GET("/upstream-response-header-timeout/enabled", s.mgmt.GetUpstreamResponseHeaderTimeoutEnabled)
		mgmt.PUT("/upstream-response-header-timeout/enabled", s.mgmt.PutUpstreamResponseHeaderTimeoutEnabled)
		mgmt.PATCH("/upstream-response-header-timeout/enabled", s.mgmt.PutUpstreamResponseHeaderTimeoutEnabled)
		mgmt.GET("/upstream-response-header-timeout/initial", s.mgmt.GetUpstreamResponseHeaderTimeoutInitial)
		mgmt.PUT("/upstream-response-header-timeout/initial", s.mgmt.PutUpstreamResponseHeaderTimeoutInitial)
		mgmt.PATCH("/upstream-response-header-timeout/initial", s.mgmt.PutUpstreamResponseHeaderTimeoutInitial)
		mgmt.GET("/upstream-response-header-timeout/max", s.mgmt.GetUpstreamResponseHeaderTimeoutMax)
		mgmt.PUT("/upstream-response-header-timeout/max", s.mgmt.PutUpstreamResponseHeaderTimeoutMax)
		mgmt.PATCH("/upstream-response-header-timeout/max", s.mgmt.PutUpstreamResponseHeaderTimeoutMax)
